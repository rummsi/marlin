 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  20               // Seconds  //###rummsi
 ...
 */
#define USE_CONTROLLER_FAN  //###BigTreeTech Oficial
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN       // Set a custom pin for the controller fan  //###BigTreeTech Oficial
  ...
  #define CONTROLLER_FAN_EDITABLE           // Enable M710 configurable settings  //###BigTreeTech Oficial
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  //###BigTreeTech Oficial
...
#define HOMING_BUMP_MM      { 4, 4, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump  //###BigTreeTech Oficial
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

//#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing

#define QUICK_HOME                            // If G28 contains XY do a diagonal move first  //rummsi  //###BLTouch Auto-leveling
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 200  //###BLTouch Auto-leveling
  ...
  //#define BLTOUCH_FORCE_SW_MODE  //###BigTreeTech Oficial  //###BLTouch Auto-leveling
   ...
   */
  #define BLTOUCH_SET_5V_MODE  //###BLTouch Auto-leveling
   ...
   */
  #define BLTOUCH_HS_MODE true  //###BLTouch Auto-leveling
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu  //###BLTouch Auto-leveling
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -3.0  //###BLTouch Auto-leveling

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER }  //###BLTouch Auto-leveling
  #endif
#endif
  ...
  #define LCD_INFO_MENU  //###BigTreeTech Oficial
  ...
  #define STATUS_MESSAGE_SCROLLING  //###BigTreeTech Oficial
  ...
  #define LCD_SET_PROGRESS_MANUALLY  //###BigTreeTech Oficial
...
// LCD Print Progress options
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define BACKUP_POWER_SUPPLY         // Backup power / UPS to move the steppers on power loss  //###BigTreeTech Oficial
    #define POWER_LOSS_ZRAISE       2   // (mm) Z axis raise on resume (on power loss with UPS)  //###BigTreeTech Oficial
    //#define POWER_LOSS_PIN         44 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
    #define POWER_LOSS_STATE     HIGH   // State of pin indicating power loss  //###BigTreeTech Oficial
    #define POWER_LOSS_PULLUP           // Set pullup / pulldown as appropriate for your sensor  //###BigTreeTech Oficial
    //#define POWER_LOSS_PULLDOWN
    #define POWER_LOSS_PURGE_LEN   20   // (mm) Length of filament to purge on resume  //###BigTreeTech Oficial
    #define POWER_LOSS_RETRACT_LEN 10   // (mm) Length of filament to retract on fail. Requires backup power.  //###BigTreeTech Oficial
   ...
   */
  #define SDCARD_SORT_ALPHA  //###BigTreeTech Oficial
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting.  //###BigTreeTech Oficial
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option.  //###BigTreeTech Oficial
  ...
  #define UTF_FILENAME_SUPPORT  //###BigTreeTech Oficial

  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'  //###BigTreeTech Oficial
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu  //###BigTreeTech Oficial
  ...
  #define AUTO_REPORT_SD_STATUS           // Auto-report media status with 'M27 S<seconds>'  //###BigTreeTech Oficial
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  //###BigTreeTech Oficial
 ...
 */
#define BABYSTEPPING  //###BigTreeTech Oficial
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING  //###BigTreeTech Oficial
  #define BABYSTEP_ALWAYS_AVAILABLE         // Allow babystepping at all times (not just during movement).  //###BigTreeTech Oficial
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS         // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps  //###rummsi
  #define BABYSTEP_MULTIPLICATOR_Z  0.01    // (steps or mm) Steps or millimeter distance for each Z babystep  //###rummsi
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.  //###BigTreeTech Oficial
  ...
  #define BABYSTEP_DISPLAY_TOTAL            // Display total babysteps since last G28  //###BigTreeTech Oficial

  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY     // Enable graphical overlay on Z-offset editor  //###rummsi
  #endif
#endif
 ...
 */
#define LIN_ADVANCE  //###BigTreeTech Oficial
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.0     // Unit: mm compression per 1mm/s extruder speed  //###BigTreeTech Oficial
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE   // Enable this option to permit S-Curve Acceleration  //###BigTreeTech Oficial
 ...
 */
#define G29_RETRY_AND_RECOVER  //###BLTouch Auto-leveling
...
// G2/G3 Arc Support
//
//#define ARC_SUPPORT                 // Requires ~3226 bytes  //###rummsi
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32  //###rummsi
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 64  //###rummsi
#else
  #define BLOCK_BUFFER_SIZE 64  //###rummsi
#endif
...
#define TX_BUFFER_SIZE 128  //###rummsi
 ...
 */
#define EMERGENCY_PARSER  //###BigTreeTech Oficial
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //###BigTreeTech Oficial
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      200  // (mm) The length of filament for a complete unload.  //###BigTreeTech Oficial  //###Filament run out sensor
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    20  // (mm) Slow length, to allow time to insert material.  //###Filament run out sensor
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   200  // (mm) Load length of filament, from extruder gear to nozzle.  //###BigTreeTech Oficial  //###Filament run out sensor
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_FANS_PAUSE               // Turn off print-cooling fans while the machine is paused.  //###Filament run out sensor
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.  //###BigTreeTech Oficial
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change  //###BigTreeTech Oficial  //###Filament run out sensor

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.  //###BigTreeTech Oficial
  #define FILAMENT_UNLOAD_ALL_EXTRUDERS           // Allow M702 to unload all extruders above a minimum target temp (as set by M302)  //###Filament run out sensor
#endif
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current.  //###BigTreeTech Oficial
    #define X_CURRENT_HOME  X_CURRENT / 2  // (mA) RMS current for sensorless homing  //###BigTreeTech Oficial
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       580  //###BigTreeTech Oficial
    #define Y_CURRENT_HOME  Y_CURRENT / 2  //###BigTreeTech Oficial
    #define Y_MICROSTEPS     16
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       580  //###BigTreeTech Oficial
    #define Z_CURRENT_HOME  Z_CURRENT / 2  //###BigTreeTech Oficial
    #define Z_MICROSTEPS     16
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      650  //###BigTreeTech Oficial
    #define E0_MICROSTEPS    16
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  //###BigTreeTech Oficial
  ...
  #define Z_HYBRID_THRESHOLD      20  //###BigTreeTech Oficial
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  72  //###BigTreeTech Oficial
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70  //###BigTreeTech Oficial
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  10  //###BigTreeTech Oficial
    ...
    #define IMPROVE_HOMING_RELIABILITY  //###BigTreeTech Oficial
  #endif
   ...
   */
  #define TMC_DEBUG  //###BigTreeTech Oficial
 ...
 */
#define AUTO_REPORT_POSITION  //###BigTreeTech Oficial
...
#define M114_DETAIL           // Use 'M114` for details to check planner calculations  //###BigTreeTech Oficial
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE     // Report the new fan speed when changed by M106 (and others)  //###BigTreeTech Oficial
 ...
 */
#define HOST_ACTION_COMMANDS  //###BigTreeTech Oficial
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                  // Tell the host to pause in response to M76  //###BigTreeTech Oficial
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback  //###BigTreeTech Oficial
